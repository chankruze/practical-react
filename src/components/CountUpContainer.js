...
function CountUpContainer() {
    ...
    const { countUp,
        ...
        pauseResume,
        reset,
        update } = useCountUp(countUpProps)
        ...
        <React.Fragment>
            ...
            <div className={styles.advanceWrapper}>
                ...
                <div className={styles.buttonWrapper}>
                    ...
                    <button className={styles.btn} onClick={pauseResume}>Pause/Resume</button>
                    <button className={styles.btn} onClick={() => update(1000)}>Down to 1000</button>
                </div>
            </div>
        </React.Fragment>
    )
